...
func (in *ProjectConfig) DeepCopyInto(out *ProjectConfig) {
	*out = *in
	...
	if in.PropagateLabelsToProjectNamespace != nil {
		in, out := &in.PropagateLabelsToProjectNamespace, &out.PropagateLabelsToProjectNamespace
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.PropagateLabelsToWorkspaceNamespaces != nil {
		in, out := &in.PropagateLabelsToWorkspaceNamespaces, &out.PropagateLabelsToWorkspaceNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *WorkspaceConfig) DeepCopyInto(out *WorkspaceConfig) {
	*out = *in
	...
	if in.PropagateLabelsToWorkspaceNamespace != nil {
		in, out := &in.PropagateLabelsToWorkspaceNamespace, &out.PropagateLabelsToWorkspaceNamespace
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
